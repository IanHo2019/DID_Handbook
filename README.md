...
The data I will use are from three papers:
  ...
  * "BCGV22_gender_quota.dta" is from [Bhalotra et al. (2022)](https://www.nber.org/papers/w30103). They use the data to estimate the impact of parliamentary gender quotas (reserving seats for women in parliament) on rates of women in parliament. Note that this is a staggered treatment case.
